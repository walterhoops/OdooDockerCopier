...
You should put some desired addons to the custom src - repos.yaml, and add specific modules
to the custom src - addons.yaml, finally paste in the module folder for private repos into the 
private folder.
